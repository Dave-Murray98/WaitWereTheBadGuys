...
namespace Infohazard.HyperNav {
    ...
    public struct Triangle : IEquatable<Triangle> {
        ...
        /// </summary>
        public bool IsValid => _minVertex >= 0 && _midVertex >= 0 && _maxVertex >= 0;
        ...
        /// Invalid Triangle.
        /// </summary>
        public static readonly Triangle InvalidTriangle = new() { _minVertex = -1, _midVertex = -1, _maxVertex = -1 };
        ...
        public Triangle(int3 vertices) : this(vertices.x, vertices.y, vertices.z) { }

        /// <summary>
        /// Returns whether the triangle contains the given vertex.
        /// </summary>
        /// <param name="vertex">Vertex index to check.</param>
        /// <returns>Whether the triangle contains the vertex.</returns>
        public bool Contains(int vertex) {
            return _minVertex == vertex || _midVertex == vertex || _maxVertex == vertex;
        }

        /// <summary>
        /// Convert to int3.
        /// </summary>
        /// <returns>Triangle as int3.</returns>
        public int3 ToInt3() {
            return new int3(_minVertex, _midVertex, _maxVertex);
        }
        ...
        public override int GetHashCode() {
            return _minVertex ^ (_midVertex << 10) ^ (_maxVertex << 20);
        }
    }
}
